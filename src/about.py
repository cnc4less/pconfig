...
#
# Created: Sat Aug 25 07:02:38 2018
...
class Ui_about(object):
    def setupUi(self, about):
        ...
        self.label.setGeometry(QtCore.QRect(70, 20, 231, 20))
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.versionLB = QtWidgets.QLabel(about)
        self.versionLB.setGeometry(QtCore.QRect(120, 70, 111, 20))
        self.versionLB.setAlignment(QtCore.Qt.AlignCenter)
        self.versionLB.setObjectName("versionLB")
        self.label_2 = QtWidgets.QLabel(about)
        self.label_2.setGeometry(QtCore.QRect(90, 100, 161, 20))
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(about)
        self.label_3.setGeometry(QtCore.QRect(100, 120, 131, 20))
        ...
        self.label_4.setGeometry(QtCore.QRect(80, 40, 191, 20))
    ...
    def retranslateUi(self, about):
        ...
        self.label.setText(_translate("about", "Parallel Port Configuration Tool"))
        ...
        self.label_4.setText(_translate("about", "for LinuxCNC 2.8"))
